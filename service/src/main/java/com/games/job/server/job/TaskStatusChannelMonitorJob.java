...
@Component
public class TaskStatusChannelMonitorJob implements Job {
    /**
     * 更新任务状态
     */
    @Autowired
    ...
    private static final Logger logger = LoggerFactory.getLogger(TaskStatusChannelMonitorJob.class);
    ...
    public void execute(JobExecutionContext jobExecutionContext) throws JobExecutionException {
        ...
        jobService.modTasksStatus(taskModelList);
