...
public class JobService {
     ...
     */
    @Transactional
    public void addOrModJob(TaskModel taskModel){
        try{
            this.addTask(taskModel);
            this.addMod(taskModel);
    ...
    private void addMod(TaskModel taskModel) throws SchedulerException {
