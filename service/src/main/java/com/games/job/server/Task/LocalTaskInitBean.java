...
@Component
public class LocalTaskInitBean implements InitializingBean {
    ...
    private void  initTaskMachineStatusChannelListenerJob() throws SchedulerException {
        ...
        String taskGroup = "irsQuartz";
        String triggerName = "taskMachineStatusChannelListenerTrigger";
        String cronExpression = "0 0/1 * * * ?";
        initScheduler(jobName, taskGroup, triggerName, cronExpression,TaskMachineStatusChannelJob.class);//ok
    }
    ...
    private void  initTaskChannelListenerJob() throws SchedulerException {
        ...
        String cronExpression = "0 0/1 * * * ?";
        initScheduler(jobName, taskGroup, triggerName, cronExpression,TaskChannelJob.class);//ok
    }
